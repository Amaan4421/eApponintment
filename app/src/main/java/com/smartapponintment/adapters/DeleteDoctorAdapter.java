...
import com.smartapponintment.activities.DeleteActivity;
import com.smartapponintment.models.DoctorModel;

import java.util.ArrayList;
import java.util.Locale;

public class DeleteDoctorAdapter extends BaseAdapter{

    Context context;
    ArrayList<DoctorModel> doctorModelArrayList;
    ArrayList<DoctorModel> doctorModelArrayListFiltered;

    public DeleteDoctorAdapter(Context context, ArrayList<DoctorModel> doctorModelArrayList)
    {
